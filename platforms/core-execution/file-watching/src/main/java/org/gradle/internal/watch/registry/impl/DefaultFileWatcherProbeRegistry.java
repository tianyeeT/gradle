...
public class DefaultFileWatcherProbeRegistry implements FileWatcherProbeRegistry {
    ...
    private final Map<File, WatchProbe> watchProbesByHierarchy = new ConcurrentHashMap<>(); //TODO: refactor: split by probe file
    ...
    public void registerProbe(File watchableHierarchy, File probeLocation) {
        ...
        File probeFile = new File(probeLocation, "file-system.probe"); //TODO: refactor: multiple hierarchies can have the same probe
